        ...
        <div class="dropdown me-2">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                @if(Auth::guard('web_student')->check())
                    <li><a class="dropdown-item" href="{{ route('student.profile', Auth::guard('web_student')->id()) }}">Profile</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <form action="{{ route('home.logout') }}" method="POST" style="display:inline; width:100%;">
                            @csrf
                ...
                @else
                    <li><a class="dropdown-item" href="{{ route('home.userLog') }}">Login</a></li>
                @endif
            </ul>
        </div>
